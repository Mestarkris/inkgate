    ...
    <Layout heroContent={
      ...
      <div className="debate-body">
        <div className="wrap">
          ...
          {!isConnected && <div className="tx-err" style={{marginBottom:8}}>⚠ Connect your wallet (top right) before starting a debate.</div>}
          <button className="btn-primary" onClick={runDebate} disabled={loading || !topic.trim() || !isConnected} style={{marginBottom:32}}>
