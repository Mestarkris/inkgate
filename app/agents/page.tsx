          ...
          {AGENTS.map((agent, i) => (
            <div key={i} style={{ background: "#12121e", border: "1px solid #1e1e2e", borderRadius: 16, padding: 24 }}>
              ...
              <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                  ...
                  style={{ fontSize: 12, background: "#12121e", color: "#6366f1", border: "1px solid #6366f1", padding: "6px 14px", borderRadius: 8, textDecoration: "none" }}
                >
                  View on OKLink
                </a>
                
                  href={"https://www.oklink.com/xlayer/address/" + agent.address + "#transfers"}
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{ fontSize: 12, background: "#12121e", color: "#6b7280", border: "1px solid #1e1e2e", padding: "6px 14px", borderRadius: 8, textDecoration: "none" }}
                >
                  Transaction history
                </a>
              </div>
        ...
        <div style={{ background: "#12121e", border: "1px solid #1e1e2e", borderRadius: 16, padding: 24 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            <div style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
              <div style={{ width: 24, height: 24, borderRadius: "50%", background: "#6366f120", border: "1px solid #6366f1", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 11, color: "#6366f1", flexShrink: 0 }}>1</div>
              <p style={{ fontSize: 13, color: "#6b7280", lineHeight: 1.6 }}>User pays $0.01 USDC to the Orchestrator wallet on X Layer</p>
            </div>
            <div style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
              <div style={{ width: 24, height: 24, borderRadius: "50%", background: "#6366f120", border: "1px solid #6366f1", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 11, color: "#6366f1", flexShrink: 0 }}>2</div>
              <p style={{ fontSize: 13, color: "#6b7280", lineHeight: 1.6 }}>Orchestrator autonomously splits and sends USDC to all 3 agent wallets</p>
            </div>
            <div style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
              <div style={{ width: 24, height: 24, borderRadius: "50%", background: "#6366f120", border: "1px solid #6366f1", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 11, color: "#6366f1", flexShrink: 0 }}>3</div>
              <p style={{ fontSize: 13, color: "#6b7280", lineHeight: 1.6 }}>Each agent does its job then pays the next agent from its own wallet</p>
            </div>
            <div style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
              <div style={{ width: 24, height: 24, borderRadius: "50%", background: "#6366f120", border: "1px solid #6366f1", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 11, color: "#6366f1", flexShrink: 0 }}>4</div>
              <p style={{ fontSize: 13, color: "#6b7280", lineHeight: 1.6 }}>All 5 transactions are permanently recorded on X Layer and verifiable on OKLink</p>
            </div>
          </div>
        </div>
      </div>
