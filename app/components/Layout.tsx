    ...
    <div style={{ background: "#050508", color: "#f0f0f8", minHeight: "100vh" }}>
      <style>{`
        ...
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .ig-nav{border-bottom:1px solid var(--border);padding:16px 0}
        ...
        .ig-footer{padding:32px 0;text-align:center;color:var(--muted);font-size:12px;font-family:var(--mono);border-top:1px solid var(--border)}
