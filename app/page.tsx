        ...
        <Link href="/predictions" style={{ textDecoration: "none" }}>
          <div style={{ background: "#12121e", border: "1px solid #22c55e", borderRadius: 16, padding: "20px 24px", display: "flex", alignItems: "center", justifyContent: "space-between", cursor: "pointer", marginBottom: 12 }} onMouseEnter={(e) => (e.currentTarget.style.background = "#0e1a0e")} onMouseLeave={(e) => (e.currentTarget.style.background = "#12121e")}>
            <div>
              ...
              <p style={{ fontSize: 13, color: "#6b7280" }}>AI makes price predictions · Bet A0GI · Auto settlement onchain</p>
            </div>
        ...
        <Link href="/agents" style={{ textDecoration: "none" }}>
          <div style={{ background: "#12121e", border: "1px solid #1e1e2e", borderRadius: 16, padding: "20px 24px", display: "flex", alignItems: "center", justifyContent: "space-between", cursor: "pointer", marginBottom: 12 }} onMouseEnter={(e) => (e.currentTarget.style.borderColor = "#6366f1")} onMouseLeave={(e) => (e.currentTarget.style.borderColor = "#1e1e2e")}>
            <div>
              ...
              <p style={{ fontSize: 13, color: "#6b7280" }}>Live agent wallets · Transaction history · 0G Mainnet</p>
            </div>
        ...
        <div style={{ background: "#12121e", border: "1px solid #1e1e2e", borderRadius: 16, padding: "20px 24px" }}>
          ...
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
            <div style={{ background: "#0a0a0f", borderRadius: 10, padding: "10px 16px", flex: 1, minWidth: 140 }}>
              ...
              <p style={{ fontSize: 11, color: "#6b7280" }}>Pulls live crypto market data and researches topic</p>
